...
class _IteryPageState extends State<IteryPage> {
  ...
  fetchData() async {
    List<IteryModel> newList =
        await gettiteryes(widget.plandetails.id!, widget.day);
    setState(() {
      iteryes = newList;
    });
  }
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(hintText: 'Itery'),
                  ),
                ],
              ),
            ),
            Row(
              ...
              children: [
                ...
                TextButton(
                    onPressed: () async {
                      if (model == null) {
                        IteryModel iteryModel = IteryModel(
                            id: null,
                            itery: itercontroller.text,
                            tripid: widget.plandetails.id!,
                            day: widget.day,
                            time: iterytimecontroller.text.toString());
